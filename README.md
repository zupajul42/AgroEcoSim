...
-   Start documentation (directly in md files in the WebFrontend folder?)
...
```json
{
    "plants": [{ "V": 0.0017850252 }, { "V": 0.0015580055 }, { "V": 0.0016916988 }]
}
```
...
```json
{
    ...
    "Plants": [{ "S": "default", "P": { "X": 5, "Y": -0.01, "Z": 5 } }],
    "Obstacles": [
